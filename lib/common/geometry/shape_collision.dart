...
class ShapeCollision {
  static bool isCollision(MyShape a, MyShape b) {
    if (a is RectangleShape) {
      ...
      } else if (b is MyPolygonShape && a is MyPolygonShape) {
  ...
  static bool circleToPolygon(CircleShape a, MyPolygonShape b) {
    if (!rectToRect(a.rect, b.rect)) return false;
  ...
  static bool polygonToPolygon(MyPolygonShape a, MyPolygonShape b) {
    if (!rectToRect(a.rect, b.rect)) return false;
